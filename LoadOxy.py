...
Daily_Header =  Document.Data.Tables["Oxy Eag Daily Header"]
...
Well_List = DataValueCursor.CreateFormatted(Daily_Header.Columns["PROPNUM"])
...
ColumnC = DataColumnSignature(Daily_Header.Columns["PROPNUM"])
ColumnD = DataColumnSignature(DCA_Parameters.Columns["PROPNUM"])

joinConditionMap = {ColumnC : ColumnD}
...
#ignoredCols =[DataColumnSignature(Daily_Header.Columns["AREA"])]
